...
<aside class="side-note">
  This is actually a non-traditional definition of expansion. The more general definition of expansion in MCTS expands the selected node by only one child node then performs simulation on the child node.
</aside>
